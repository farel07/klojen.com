...
export default function EditIklanPage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    // Simulasi pengambilan data iklan berdasarkan ID
    const timer = setTimeout(() => {
      setFormData({
        nama: 'Promo Kampus Malang 2026',
        pemilik: 'Universitas Malang Raya',
        posisi: 'Sidebar',
        status: 'Aktif',
        mulai: '2026-05-15',
        berakhir: '2026-06-15',
        url: 'https://kampus-malang.com/promo',
      });
      // Jika ada gambar dari server:
      // setImagePreview('/images/dummy-iklan.png');
      setIsLoading(false);
    }, 500);
    ...
    <div className="space-y-6 pb-20 relative min-h-screen">
      ...
      <div>
        ...
        <div className="text-sm font-medium text-gray-400 flex items-center">
          ...
          <span className="text-gray-600">Edit Iklan</span>
        </div>
      </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="p-8 flex flex-col items-center justify-center text-center">
              ...
              <p className="text-sm text-gray-500 font-medium">
                Perubahan telah disimpan dan tayang.
              </p>
            </div>
          </div>
        </div>
