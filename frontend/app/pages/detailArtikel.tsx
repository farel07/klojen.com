            ...
            <article className="lg:col-span-2 border border-gray-200 rounded-3xl p-6 md:p-10 bg-white">
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <button
                  ...
                  className={`border rounded-full px-5 py-2 flex items-center space-x-2 transition-colors ${
                    bookmarked
              ...
              {/* Article Body — render HTML dari backend */}
              <div
                className="text-gray-800 space-y-6 leading-relaxed text-lg mb-10 prose max-w-none"
